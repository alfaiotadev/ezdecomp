...
def main():
    ...
    # The class-location comparison is vestigial tooling from a different (Java-
    # package-based) decomp and depends on data/java_class_map.yaml, which is not
    # part of this project. Skip it when the map is absent so --format and the
    # style checks below still run.
    class_map_path = "data/java_class_map.yaml"
    if os.path.exists(class_map_path):
        nested_class_map = load_class_map_yaml(class_map_path)
