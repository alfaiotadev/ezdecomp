#include "kestrel/script/actions/CharacterAction_SetPushable.h"

enum GAMEOBJFLAG {
    GAMEOBJFLAG_NONPUSHABLE = 0x8,
};
...
ActionState CharacterAction_SetPushable::CharacterExec(ApiCharacter* pCharacter, ScriptContext& context) {
    ...
    pMech->SetGameFlag(GAMEOBJFLAG_NONPUSHABLE, !pBool->m_Value, cGameObjFlags::Priority::DEFAULT);
