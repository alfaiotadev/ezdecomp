#include "kestrel/script/actions/VehicleAction_DisableControls.h"
...
public:
    void DisableInputControls(bool disabled);
};

ActionState VehicleAction_DisableControls::VehicleExec(ApiVehicle* pVehicle, ScriptContext& context) {
    ...
    pGeneric->DisableInputControls(disable);
