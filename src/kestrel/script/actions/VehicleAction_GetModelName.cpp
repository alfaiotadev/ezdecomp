#include "kestrel/script/actions/VehicleAction_GetModelName.h"
...
ActionState VehicleAction_GetModelName::VehicleExec(ApiVehicle* pVehicle, ScriptContext& context) {
