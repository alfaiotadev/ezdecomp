...
public:
    int GetConversationLineCount(const char*);
};
...
ActionState SAction_GetConversationLineCount::Exec(ScriptContext& context) {
    context.SetReturn<SVarFloat, float>(
        0, g_pLC_Conversations->GetConversationLineCount(
